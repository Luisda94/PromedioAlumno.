...
public class Main {
    public static void main(String[] args) {
		...
		/*
		 * La clase Main cuenta con el método main que correrá el programa Java. Es aquí
		 * donde se poblará la lista de alumnos y se inyectaran las dependencias
		 * necesarias para que las clases Calculadora y Profesor puedan operar
		 * correctamente. • Solo en la clase Main se puede crear nuevos objetos
		 */
        ...
        // Mostrar alumnos con promedios calculados
